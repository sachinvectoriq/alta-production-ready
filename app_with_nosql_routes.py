...
from nosql_reports_uniquecolnames import get_unique_values
@app.route('/unique-values', methods=['GET'])
def call_nosql_unique_colvalues():
    user_name = request.args.get('user_name', None)
    try:
        #log("INFO", "Received request to fetch access to reports", user_name=user_name)
...
@app.route('/nosql/log/user/login',methods=['POST'])
...
@app.route('/nosql/alta_filters/add',methods=['POST'])
...
@app.route('/nosql/alta_filters/grouped_modifiers', methods=['POST'])
...
@app.route('/nosql/alta_filters/update_filter', methods=['PUT'])
...
@app.route('/nosql/alta_filters/delete', methods=['DELETE'])
...
@app.route('/nosql/alta_filters/delete_modifier', methods=['DELETE'])
...
@app.route('/nosql/insert_access', methods=['POST'])
...
@app.route('/nosql/delete_access/<int:record_id>', methods=['DELETE'])
...
@app.route('/nosql/fetch_access', methods=['GET'])
...
@app.route('/nosql/get_token_limit', methods=['GET'])
...
@app.route('/nosql/set_token', methods=['POST'])
def nosql_setlimit():
    user_name = request.args.get('user_name', None) # Defaulting to None
    try:
        #log("INFO", "Received request to set token limit.", user_name=user_name)
...
@app.route('/nosql/log/text/translation',methods=['POST'])
...
@app.route('/nosql/log_contextsense', methods=['POST'])
...
@app.route('/nosql/process_context_sense', methods=['POST'])
...
@app.route('/nosql/core_prompt/add', methods=['POST'])
...
@app.route('/nosql/core_prompt/get', methods=['GET'])
...
@app.route('/nosql/core_prompt/delete_core_prompt', methods=['DELETE'])
...
@app.route('/nosql/core_prompt/update', methods=['PUT'])
...
@app.route('/nosql/api/settings/azure/set',methods=['POST'])
...
@app.route('/nosql/api/settings/azure/get', methods=['GET'])
...
@app.route('/nosql/api/translate/azure/text', methods=['POST'])
...
@app.route('/nosql/api/translate/azure/documents', methods=['POST'])
...
@app.route('/nosql/api/translate/azure/documents/status', methods=['POST'])
...
@app.route('/nosql/api/settings/deepl/get', methods=['POST'])
...
@app.route('/nosql/api/settings/deepl/set', methods=['POST'])
...
@app.route('/nosql/api/translate/deepl/documents',methods=['POST'])
...
@app.route('/nosql/api/translate/deepl/documents/check/status',methods=['POST'])
...
@app.route('/nosql/api/translate/deepl/documents/status',methods=['POST'])
...
@app.route('/nosql/api/translate/deepl/text', methods=['POST'])
...
@app.route('/nosql/log/document/translation',methods=['POST'])
...
@app.route('/nosql/doc_data_report', methods=['GET'])
...
@app.route('/nosql/feedback', methods=['POST'])
